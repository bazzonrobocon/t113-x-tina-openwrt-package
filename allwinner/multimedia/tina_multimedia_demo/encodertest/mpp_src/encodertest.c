...
static void PrintDemoUsage(void)
{
    ...
    printf(" for h264 instance : encodertest -i /mnt/UDISK/decodeNV21_1920_1088_1.yuv -o /mnt/UDISK/1080.h264 -s 1088 -d 1088 -n 100 -f 0 -pformat 1\n");
    printf(" for h265 instance : encodertest -i /mnt/UDISK/1080p_yuv420.yuv -o /mnt/UDISK/1080.h265 -s 1080 -d 1080 -n 100 -f 3 -pformat 2\n");
...
static int saveWbYuv(encoder_Context* pEncContext, encode_param_t *encode_param)
{
    ...
    VencGetParameter(pEncContext->pVideoEnc, VENC_IndexParamSetThumbScaler, &ThumbScale);
