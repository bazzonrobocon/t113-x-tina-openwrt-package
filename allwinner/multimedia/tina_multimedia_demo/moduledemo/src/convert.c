...
int NV21ToYV12(void *save_YV12,void *NV21,int width,int height)
{
    ...
    unsigned char *dst_v = NULL;
    unsigned char *dst_u = NULL;
    int i = 0;
    int j = 0;
    ...
    src_uv = (unsigned char *)NV21 + width * height;
    dst_v = (unsigned char *)save_YV12 + width * height;
    dst_u = (unsigned char *)dst_v + (width * height/4);
...
int NV21ToYU12(void *save_YU12,void *NV21,int width,int height)
{
    ...
    src_uv = (unsigned char *)NV21 + width * height;
    dst_u = (unsigned char *)save_YU12 + width * height;
    dst_v = (unsigned char *)dst_u + (width * height/4);
...
{
    unsigned char *src_yuyv = NULL;
    unsigned char *dst_nv21 = NULL;
    unsigned char *dst_nv21_v = NULL;
    unsigned char *dst_nv21_u = NULL;
    ...
    src_yuyv = (unsigned char*)YUYV;
    dst_nv21 = (unsigned char*)save_NV21;
    dst_nv21_v = (unsigned char*)save_NV21 + width*height;
    dst_nv21_u = (unsigned char*)save_NV21 + width*height+1;
...
int YUV420ToRGB24(void *RGB24,void *YUV420,int width,int height)
{
    ...
    src_y = (unsigned char *)YUV420;
    src_u = (unsigned char *)YUV420 + width * height;
    src_v = (unsigned char *)YUV420 + width * height * 5 / 4;
    dst_RGB = (unsigned char *)RGB24;
...
int YVU420ToRGB24(void *RGB24,void *YVU420,int width,int height)
{
    ...
    src_y = (unsigned char *)YVU420;
    src_u = (unsigned char *)YVU420 + width * height* 5 / 4;
    src_v = (unsigned char *)YVU420 + width * height;
    dst_RGB = (unsigned char *)RGB24;
...
int YUYVToRGB24(void *RGB24,void *YUYV,int width,int height)
{
    ...
    src_y = (unsigned char *)YUYV;
    src_u = (unsigned char *)YUYV + 1;
    src_v = (unsigned char *)YUYV + 3;
    dst_RGB = (unsigned char *)RGB24;
...
int YVYUToRGB24(void *RGB24,void *YVYU,int width,int height)
{
    ...
    const unsigned char *src_u = NULL;
    const unsigned char *src_v = NULL;
    unsigned char *dst_RGB = NULL;
    ...
    src_y = (unsigned char *)YVYU;
    src_u = (unsigned char *)YVYU + 3;
    src_v = (unsigned char *)YVYU + 1;
    dst_RGB = (unsigned char *)RGB24;
...
int UYVYToRGB24(void *RGB24,void *UYVY,int width,int height)
{
    ...
    src_y = (unsigned char *)UYVY + 1;
    src_u = (unsigned char *)UYVY;
    src_v = (unsigned char *)UYVY + 2;
    dst_RGB = (unsigned char *)RGB24;
...
int VYUYToRGB24(void *RGB24,void *VYUY,int width,int height)
{
    ...
    src_y = (unsigned char *)VYUY + 1;
    src_u = (unsigned char *)VYUY + 2;
    src_v = (unsigned char *)VYUY;
    dst_RGB = (unsigned char *)RGB24;
...
int NV12ToRGB24(void *RGB24,void *NV12,int width,int height)
{
    ...
    src_y = (unsigned char *)NV12;
    src_v = (unsigned char *)NV12 + width * height + 1;
    src_u = (unsigned char *)NV12 + width * height;
    dst_RGB = (unsigned char *)RGB24;
...
int NV21ToRGB24(void *RGB24,void *NV21,int width,int height)
{
    ...
    src_y = (unsigned char *)NV21;
    src_v = (unsigned char *)NV21 + width * height;
    src_u = (unsigned char *)NV21 + width * height + 1;
    dst_RGB = (unsigned char *)RGB24;
...
int YV12ToRGB24(void *RGB24,void *YV12,int width,int height)
{
    ...
    src_y = (unsigned char *)YV12;
    src_v = (unsigned char *)YV12 + width * height;
    src_u = (unsigned char *)YV12 + width * height * 5 / 4;
    dst_RGB = (unsigned char *)RGB24;
...
int NV16ToRGB24(void *RGB24,void *NV16,int width,int height)
{
    ...
    src_y = (unsigned char *)NV16;
    src_u = (unsigned char *)NV16 + width * height;
    src_v = (unsigned char *)NV16 + width * height + 1;
    dst_RGB = (unsigned char *)RGB24;
...
int NV61ToRGB24(void *RGB24,void *NV61,int width,int height)
{
    ...
    src_y = (unsigned char *)NV61;
    src_u = (unsigned char *)NV61 + width * height + 1;
    src_v = (unsigned char *)NV61 + width * height;
    dst_RGB = (unsigned char *)RGB24;
