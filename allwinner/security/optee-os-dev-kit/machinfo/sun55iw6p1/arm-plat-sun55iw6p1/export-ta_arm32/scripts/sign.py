...
def get_args(logger):
    ...
    parser.add_argument('--aes_key', help='Name of aes key file',dest='aes_keyf')
    parser.add_argument('--using-derive-key', help='aes key is derive from rotpk',
                action = 'store_true',default=False,dest='using_derive_key')
