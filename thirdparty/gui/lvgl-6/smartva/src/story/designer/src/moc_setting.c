...
static ui_image_t num_image_list[10] = {
	{NULL, LV_IMAGE_PATH"0.png"},
	{NULL, LV_IMAGE_PATH"1.png"},
	{NULL, LV_IMAGE_PATH"2.png"},
	{NULL, LV_IMAGE_PATH"3.png"},
	{NULL, LV_IMAGE_PATH"4.png"},
	{NULL, LV_IMAGE_PATH"5.png"},
	{NULL, LV_IMAGE_PATH"6.png"},
	{NULL, LV_IMAGE_PATH"7.png"},
	{NULL, LV_IMAGE_PATH"8.png"},
	{NULL, LV_IMAGE_PATH"9.png"}
};
...
void time_num_pic_uninit(void)
{
	free_image_buff_form_list(num_image_list, sizeof(num_image_list)/sizeof(num_image_list[0]));
}
...
static void time_set_cb(struct _lv_obj_t * obj, lv_event_t event)
{
	...
	if (event == LV_EVENT_CLICKED)
	{
		...
		if(change_flage == 0){
			lv_img_set_src(para.ui.image_hour1, get_image_buff_form_list(num_image_list, sizeof(num_image_list)/sizeof(num_image_list[0]), set_time.tm_hour/10));
			lv_img_set_src(para.ui.image_hour2, get_image_buff_form_list(num_image_list, sizeof(num_image_list)/sizeof(num_image_list[0]), set_time.tm_hour%10));
		}else{
			lv_img_set_src(para.ui.image_min1, get_image_buff_form_list(num_image_list, sizeof(num_image_list)/sizeof(num_image_list[0]), set_time.tm_min/10));
			lv_img_set_src(para.ui.image_min2, get_image_buff_form_list(num_image_list, sizeof(num_image_list)/sizeof(num_image_list[0]), set_time.tm_min%10));
		}
...
static void hidden_all_contents(void)
{
	...
	lv_ddlist_close(para.drop_down_list[DROP_DOWN_AUTO_POWEROFF].drop_down, LV_ANIM_OFF);
	...
	lv_ddlist_close(para.drop_down_list[DROP_DOWN_AUTO_SLEEP].drop_down, LV_ANIM_OFF);
	lv_obj_set_hidden(para.drop_down_list[DROP_DOWN_AUTO_CLOSE_SCREEN].drop_down, false);
	lv_obj_set_hidden(para.drop_down_list[DROP_DOWN_AUTO_CLOSE_SCREEN].label, false);
	lv_ddlist_close(para.drop_down_list[DROP_DOWN_AUTO_CLOSE_SCREEN].drop_down, LV_ANIM_OFF);
	...
	lv_ddlist_close(para.drop_down_list_language, LV_ANIM_OFF);
...
static void setting_cb(struct _lv_obj_t * btn, lv_event_t event)
{
	...
	if (event == LV_EVENT_FOCUSED)
	{
		...
		if(!strncmp(item_name, get_text_by_id(LANG_SET_DISPLAY), strlen(get_text_by_id(LANG_SET_DISPLAY)))) {//display
			...
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_DISPLAY));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
			...
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_GENERAL));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
			...
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_LANG));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
			...
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_INFORMATION));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
			...
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_DEFAULT));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
			...
			fc_list_cont = NULL;
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_PASSWORD));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
			...
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_TIME));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
		}else if(!strncmp(item_name, get_text_by_id(LANG_SET_WALLPAPER), strlen(get_text_by_id(LANG_SET_WALLPAPER)))) {//wallpaper
			com_info("no this function\n");
			fc_list_cont = NULL;
			lv_label_set_text(para.ui.label_10, get_text_by_id(LANG_SET_WALLPAPER));
			lv_label_set_style(para.ui.label_10, LV_LABEL_STYLE_MAIN, &style0_label_2);
		} else {
			com_info("no this function\n");
			fc_list_cont = NULL;
...
static void ui_language_drop_list(void)
{
	...
	style0_language_cont.body.opa = 7;
	style0_language_cont.body.border.opa = 7;
...
static void ui_drop_down_list_init(void)
{
	...
	style0_drop_down_list_sleep.text.line_space = 7;
	style0_drop_down_list_sleep.body.padding.top = 7;
#if CONFIG_FONT_ENABLE
