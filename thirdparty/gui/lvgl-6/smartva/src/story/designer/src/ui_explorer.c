...
static lv_style_t style0_file_size;
static lv_style_t style0_file_time;

/**********************
 *  images and fonts
 **********************/
static void *image_1_home_return_png = NULL;
static void *image_3_explorer_opendir_png = NULL;
static void *image_2_explorer_return_png = NULL;
...
void explorer_auto_ui_create(explorer_ui_t *ui)
{
	...
	image_1_home_return_png = (void *)parse_image_from_file(LV_IMAGE_PATH"home_return.png");
	...
	lv_obj_set_pos(ui->container_1, 1, 315);
	...
	lv_obj_set_pos(ui->label_4, 5, 47);
	...
	lv_obj_set_pos(ui->label_7, 4, 92);
	...
	image_3_explorer_opendir_png = (void *)parse_image_from_file(LV_IMAGE_PATH"explorer_opendir.png");
	lv_img_set_src(ui->image_3, image_3_explorer_opendir_png);

#endif // LV_USE_IMG

#ifdef LV_USE_IMG
	ui->image_2 = lv_img_create(ui->cont, NULL);
	lv_obj_set_pos(ui->image_2, 763, 59);
	lv_obj_set_size(ui->image_2, 32, 32);
	image_2_explorer_return_png = (void *)parse_image_from_file(LV_IMAGE_PATH"explorer_return.png");
	lv_img_set_src(ui->image_2, image_2_explorer_return_png);

#endif // LV_USE_IMG

#ifdef LV_USE_LABEL
	lv_style_copy(&style0_file_size, &lv_style_transp);

	ui->File_Size = lv_label_create(ui->container_1, NULL);
	lv_label_set_text(ui->File_Size, "");
	lv_label_set_long_mode(ui->File_Size, LV_LABEL_LONG_SROLL_CIRC);
	lv_obj_set_pos(ui->File_Size, 2, 68);
	lv_obj_set_size(ui->File_Size, 189, 22);
	lv_label_set_style(ui->File_Size, LV_LABEL_STYLE_MAIN, &style0_file_size);
#endif // LV_USE_LABEL

#ifdef LV_USE_LABEL
	lv_style_copy(&style0_file_time, &lv_style_transp);

	ui->file_time = lv_label_create(ui->container_1, NULL);
	lv_label_set_text(ui->file_time, "");
	lv_label_set_long_mode(ui->file_time, LV_LABEL_LONG_SROLL_CIRC);
	lv_obj_set_pos(ui->file_time, 1, 119);
	lv_obj_set_size(ui->file_time, 180, 22);
	lv_label_set_style(ui->file_time, LV_LABEL_STYLE_MAIN, &style0_file_time);
#endif // LV_USE_LABEL
...
void explorer_auto_ui_destory(explorer_ui_t *ui)
{
	...
	free_image(image_3_explorer_opendir_png);
	free_image(image_2_explorer_return_png);
}
