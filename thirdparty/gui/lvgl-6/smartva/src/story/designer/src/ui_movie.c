...
static lv_style_t style0_ab_page;
static lv_style_t style0_label_slider_a;
static lv_style_t style0_label_slider_b;
...
static lv_style_t style0_sound_track_page;
...
void movie_auto_ui_create(movie_ui_t *ui)
{
...
#ifdef LV_USE_PAGE
	lv_style_copy(&style0_ab_page, &lv_style_pretty_color);
	...
	lv_page_set_style(ui->ab_page, LV_PAGE_STYLE_BG, &style0_ab_page);
#endif // LV_USE_PAGE
...
#ifdef LV_USE_LABEL
	lv_style_copy(&style0_label_slider_a, &lv_style_transp);
	style0_label_slider_a.text.color = lv_color_hex(0x000000);
	style0_label_slider_a.text.line_space = 2;
	...
	lv_obj_set_pos(ui->label_slider_a, 176, 25);
	lv_obj_set_size(ui->label_slider_a, 62, 19);
	lv_label_set_style(ui->label_slider_a, LV_LABEL_STYLE_MAIN, &style0_label_slider_a);
#endif // LV_USE_LABEL

#ifdef LV_USE_LABEL
	lv_style_copy(&style0_label_slider_b, &lv_style_transp);
	style0_label_slider_b.text.color = lv_color_hex(0x000000);
	style0_label_slider_b.text.line_space = 2;

	ui->label_slider_b = lv_label_create(ui->ab_page, NULL);
	lv_label_set_text(ui->label_slider_b, "00:00:00");
	lv_label_set_long_mode(ui->label_slider_b, LV_LABEL_LONG_EXPAND);
	lv_obj_set_pos(ui->label_slider_b, 175, 81);
	lv_obj_set_size(ui->label_slider_b, 62, 19);
	lv_label_set_style(ui->label_slider_b, LV_LABEL_STYLE_MAIN, &style0_label_slider_b);
#endif // LV_USE_LABEL
...
#ifdef LV_USE_PAGE
	lv_style_copy(&style0_sound_track_page, &lv_style_pretty_color);
	...
	lv_page_set_style(ui->sound_track_page, LV_PAGE_STYLE_BG, &style0_sound_track_page);
#endif // LV_USE_PAGE
