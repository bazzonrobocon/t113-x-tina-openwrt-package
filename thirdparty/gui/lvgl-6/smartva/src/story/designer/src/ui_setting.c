...
static lv_style_t style0_button_backlight;
...
void setting_auto_ui_create(setting_ui_t *ui)
{
...
#ifdef LV_USE_BTN
	lv_style_copy(&style0_button_backlight, &lv_style_btn_rel);
	...
	lv_btn_set_style(ui->button_backlight, LV_BTN_STYLE_REL, &style0_button_backlight);
#endif // LV_USE_BTN
