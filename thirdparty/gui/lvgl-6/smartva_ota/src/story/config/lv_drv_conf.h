...
#if USE_SUNXI_KEY
#define KEY_DEV_NAME_0   "/dev/input/event0"
#define KEY_DEV_NAME_1   "/dev/input/event1"
#endif
#endif
...
#ifdef __CTP_USE__
#define CTPDEV_NAME   "/dev/input/event1"
#endif

/*
//tslib 在profile 中已指定该节点的环境变量，此处无用
#ifdef __RTP_USE__
#define RTPDEV_NAME   "/dev/input/event3"
#endif
*/
...
#if USE_SUNXI_KEY
#define KEY_DEV_NAME_0   "/dev/input/event0"
//#define KEY_DEV_NAME_2   "/dev/input/event1"
#endif
