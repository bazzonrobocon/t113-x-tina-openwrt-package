...
GPU_KO_DIR:=$(LICHEE_OUT_DIR)/$(LICHEE_IC)/kernel/staging/lib/modules/$(LICHEE_KERNEL_VERSION)/pvrsrvkm.ko
GPU_KO_DIR+=$(LICHEE_OUT_DIR)/$(LICHEE_IC)/kernel/staging/lib/modules/$(LICHEE_KERNEL_VERSION)/dc_sunxi.ko
endif
